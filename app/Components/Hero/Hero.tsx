    ...
    <>
      <div className="page-wrapper" suppressHydrationWarning ref={heroRef}>
        ...
        >
          ...
          >
            <div
              className={`hero-tag fade-up ${visible ? "visible" : ""} delay-1`}
            >
...
>
  Studio+Shoot<em>+Editing</em>
  <br />
  Editing at unbeatable price
</h1>
            <div
              className={`gold-line fade-up ${
                visible ? "visible" : ""
              } delay-3`}
            />

            <p
              className={`hero-sub fade-up ${visible ? "visible" : ""} delay-3`}
            ...
            <div
              className={`fade-up ${visible ? "visible" : ""} delay-4`}
              style={{
                display: "flex",
                gap: 12,
                flexWrap: "wrap",
        ...
        ══════════════════════════════ */}
        <section
          style={{ maxWidth: 1200, margin: "0 auto", padding: "0 2rem 80px" }}
        >
            ...
            {[
              {
                ...
                icon: "🖼",
                name: "Portrait",
                desc: "Intimate, expressive portraits that reveal your true character through careful lighting and composition.",
              },
              {
                num: "02",
                icon: "💍",
                name: "Wedding",
                desc: "Timeless wedding photography capturing the emotion, elegance and joy of your most important day.",
              },
              {
                num: "03",
                icon: "👗",
                name: "Fashion",
                desc: "High-concept editorial and commercial fashion imagery with a bold, sophisticated visual language.",
              },
              {
                num: "04",
                icon: "📸",
                name: "Commercial",
                desc: "Brand and product photography that tells your story and connects with your audience.",
              },
              {
                num: "05",
                icon: "🎉",
                name: "Events",
                desc: "Dynamic event coverage from corporate functions to private celebrations, every moment preserved.",
              },
              {
                num: "06",
                icon: "👥",
                name: "Models",
                desc: "Professional model portfolio shoots — men, women and children — for agencies and individuals.",
              },
            ].map((s, i) => (
        ...
        <div className="testimonial-section">
          <p className="testimonial-quote">
            "SKG Production transformed our wedding memories into timeless art.
            Every photograph feels like a painting — deeply personal, flawlessly
            composed."
          </p>
